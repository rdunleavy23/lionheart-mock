...
export const locations: Location[] = [
  ...
  {
    slug: "arvada",
    name: "Lionheart Children's Academy at Revive Church",
    label: "Arvada, CO",
    shortName: "Arvada",
    state: "Colorado",
    city: "Arvada",
    neighborhood: "Revive Church",
    fullAddress: "8230 W. 80th Avenue, Unit 1, Arvada, CO 80005",
    latitude: 39.8403,
    longitude: -105.1264,
    phone: "(303) 800-2626",
    email: "revive@lionheartkid.org",
    hours: "Monday - Friday, 6:30 AM - 6:00 PM",
    ageGroups: ["infants", "toddlers", "preschool", "pre-k", "trailblazers"],
    accreditation: ["State Licensed", "Colorado Shines", "2025 Best of the Best"],
    director: {
      name: "Cathy",
      role: "Academy Director",
      bio: "Cathy brings warmth and expertise to our Arvada center, creating a nurturing environment where every child feels loved and valued.",
    },
    staff: [
      {
